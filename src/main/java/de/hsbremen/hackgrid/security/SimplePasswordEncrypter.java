 ...
 *
 */
public class SimplePasswordEncrypter implements PasswordEncrypter{
	...
	/**
	 * Creates a SHA-256 hash value from a password and a salt.
	 * 
	 * @param password
	 * @param salt
	 * @return byte array with hashed value from the password and the salt
	 */

...
public final class AcseAssociation {
	...
	// Private variable for acse_apdu, which is used in the method listenForCn.
	...
	/**
	 * This function returns the authentication parameter, which is set by the client. The function
	 * returns null, if nothing is set.
	 * 
	 * @return authentication Parameter
	 */
	public String getAuthenticationParameter() {
		if (acseApdu.aarq.calling_authentication_value == null) {
			return null;
		} else {
